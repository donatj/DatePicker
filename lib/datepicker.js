...
var DatePicker = /** @class */ (function () {
    ...
    DatePicker.prototype.updatePosition = function () {
        ...
        var pickerRect = this.pageRect(this.pickerInput);
        ...
        var calRect = this.pageRect(this.calendar);
    ...
    DatePicker.prototype.createButton = function (className, text, onClick, ariaLabel) {
    ...
    DatePicker.prototype.renderDayView = function () {
        ...
        var monthButton = this.createButton('DatePicker-month-label', this.format(workingDate, 'F', false), function () {
            _this.currentView = 'month';
            _this.render();
            _this.pickerInput.focus();
        }, 'Choose month');
        var yearButton = this.createButton('DatePicker-year-label', this.format(workingDate, 'Y', false), function () {
        ...
        var next = this.createButton('DatePicker-next-month', this.options.next, function () {
            _this.setMonth(_this.options.date.getMonth() + 1);
            _this.pickerInput.focus();
        }, 'Next month');
        var prev = this.createButton('DatePicker-prev-month', this.options.prev, function () {
            _this.setMonth(_this.options.date.getMonth() - 1);
            _this.pickerInput.focus();
        }, 'Previous month');
    ...
    DatePicker.prototype.renderMonthView = function () {
        ...
        header.appendChild(yearButton);
        this.calendar.appendChild(header);
        var next = this.createButton('DatePicker-next-year', this.options.next, function () {
            _this.setYear(_this.options.date.getFullYear() + 1);
            _this.pickerInput.focus();
        }, 'Next year');
        var prev = this.createButton('DatePicker-prev-year', this.options.prev, function () {
            _this.setYear(_this.options.date.getFullYear() - 1);
            _this.pickerInput.focus();
        }, 'Previous year');
        header.appendChild(next);
        ...
        var _loop_1 = function (i) {
            ...
            var button = this_1.createButton('DatePicker-month', monthName, function () {
                _this.currentView = 'day';
                _this.setMonth(i);
                _this.pickerInput.focus();
            }, "Choose ".concat(this_1.format(new Date(workingDate.getFullYear(), i, 1), 'F', false)));
    ...
    DatePicker.prototype.renderYearView = function () {
        ...
        this.calendar.appendChild(header);
        var next = this.createButton('DatePicker-next-years', this.options.next, function () {
            _this.setYear(_this.options.date.getFullYear() + 12);
            _this.pickerInput.focus();
        }, 'Next 12 years');
        var prev = this.createButton('DatePicker-prev-years', this.options.prev, function () {
            _this.setYear(_this.options.date.getFullYear() - 12);
            _this.pickerInput.focus();
        }, 'Previous 12 years');
        header.appendChild(next);
        ...
        var _loop_2 = function (i) {
            ...
            var button = this_2.createButton('DatePicker-year', year.toString(), function () {
                _this.currentView = 'month';
                _this.setYear(year);
                _this.pickerInput.focus();
            }, "Choose ".concat(year));
    ...
    DatePicker.prototype.pageRect = function (elm) {
        ...
        return new /** @class */ (function () {
            function class_1() {
                this.bottom = (irect.y - (irect.top - irect.bottom)) + window.scrollY;
                this.top = irect.y + window.scrollY;
                this.left = irect.x - window.scrollX;
                this.right = (irect.x - (irect.left - irect.right)) - window.scrollX;
            }
