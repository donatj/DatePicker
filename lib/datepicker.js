...
var DatePicker = /** @class */ (function () {
    ...
    function DatePicker(pickerInput, options) {
        ...
        var hideTimeout = 0;
        var cancelHide = function () { return clearTimeout(hideTimeout); };
    ...
    DatePicker.prototype.setMonth = function (month) {
        var _this = this;
        this.updateCalendar('day', function () { return _this.options.date.setMonth(month); });
    };
    /**
    ...
    DatePicker.prototype.setYear = function (year) {
        var _this = this;
        this.updateCalendar('day', function () { return _this.options.date.setFullYear(year); });
    };
    DatePicker.prototype.updateCalendar = function (view, update) {
        update();
        this.render(view);
    };
    /**
    ...
    DatePicker.prototype.renderMonthView = function () {
        ...
        var next = createButton('DatePicker-next-year', this.options.next, function () {
            _this.updateCalendar('month', function () { return _this.options.date.setFullYear(_this.options.date.getFullYear() + 1); });
            _this.pickerInput.focus();
        }, 'Next year');
    ...
    DatePicker.prototype.renderYearView = function () {
        ...
        var next = createButton('DatePicker-next-years', this.options.next, function () {
            _this.updateCalendar('year', function () { return _this.options.date.setFullYear(_this.options.date.getFullYear() + 12); });
            _this.pickerInput.focus();
        }, 'Next 12 years');
        ...
        var _loop_2 = function (i) {
            ...
            var button = createButton('DatePicker-year-button', year.toString(), function () {
                _this.updateCalendar('month', function () { return _this.options.date.setFullYear(year); });
                _this.pickerInput.focus();
            }, "Choose ".concat(year));
            td.appendChild(button);
            var lastRow = tbl.lastChild;
