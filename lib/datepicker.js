...
var DatePicker = /** @class */ (function () {
     ...
     * @constructor
     */
    function DatePicker(pickerElm, options) {
        var _this = this;
        this.pickerElm = pickerElm;
        this.offset = 0;
        ...
        var hideTimeout = 0;
        this.pickerElm.addEventListener('focus', function () {
            clearTimeout(hideTimeout);
            _this.display();
        });
        this.pickerElm.addEventListener('blur', function () {
        ...
        if (this.options.parseUserInput) {
            ...
            this.pickerElm.addEventListener('input', function () {
                wasInput_1 = true;
            });
            this.pickerElm.addEventListener('change', function () {
                if (wasInput_1) {
                    var userDate = void 0;
                    try {
                        if (typeof _this.options.parseUserInput == "function") {
                            userDate = _this.options.parseUserInput(_this.pickerElm.value);
                        }
                        else {
                            userDate = _this.parseUserDate(_this.pickerElm.value);
                        }
                        _this.setPickerDate(userDate);
                    }
                    catch (_a) {
    ...
    DatePicker.prototype.display = function () {
        var rect = this.pageRect(this.pickerElm);
            ...
            if ((this.options.minDate === null || this.options.minDate <= dayDate)
                ...
                td.addEventListener('click', (function (date) {
                    return function () {
                        ...
                        _this.options.onPick.apply(_this.pickerElm, [date]);
                        if (_this.options.triggerChangeEvent) {
                            if (_this.pickerElm.dispatchEvent) { // IE9+
                                var evt = document.createEvent("HTMLEvents");
                                evt.initEvent('change', true, true);
                                return !_this.pickerElm.dispatchEvent(evt);
                            }
                        }
                        return undefined;
                    };
